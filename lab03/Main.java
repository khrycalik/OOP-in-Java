...
//Empty first name or last name, cannot create
//Person{firstName='Karol', lastName='Babacki', age=21, weight=74, height=183}
//[Person{firstName='Adam', lastName='Abacki', age=32, weight=78, height=186}, Person{firstName='Karol', lastName='Babacki', age=21, weight=74, height=183}, Person{firstName='Piotr', lastName='Cabacki', age=25, weight=92, height=191}]
//[Person{firstName='Adam', lastName='Abacki', age=32, weight=78, height=186}, Person{firstName='Piotr', lastName='Cabacki', age=25, weight=92, height=191}]
//personList.equals(personList2): true
//personList.equals(personList3): false
//[Person{firstName='Karol', lastName='Babacki', age=21, weight=74, height=183}, Person{firstName='Piotr', lastName='Cabacki', age=25, weight=92, height=191}, Person{firstName='Adam', lastName='Abacki', age=32, weight=78, height=186}]